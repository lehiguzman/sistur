                ...
                <div class="card">
                    <div class="card-header">
                       ...
                       <h2>Ramas</h2><br/>
                        ...
                        <button class="btn btn-primary btn-lg" type="button" @click="abrirModal('rama', 'registrar')">
                            <i class="fa fa-plus fa-2x"></i>&nbsp;&nbsp;Agregar rama
                        </button>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>                               
                                <tr v-for="rama in ramas" :key="rama.id">
                                    ...
                                    <td v-text="rama.titulo"></td> 
                                    <td v-text="rama.descripcion"></td>                                  
                                    <td>
                                        <button type="button" class="btn btn-info btn-md" @click="abrirModal( 'rama', 'actualizar', rama )">
                                          <i class="fa fa-edit fa-2x"></i> Editar
                                        </button> &nbsp;
                                    </td>                               
                                    <td>
                                        <button type="button" class="btn btn-danger btn-md" @click="eliminarRama(rama.id)">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div v-show="errorRama" class="form-group row div-error">
                                
                                <div class="text-center text-error">
                                    
                                    <div v-for="error in errorMostrarMsjRama" :key="error" v-text="error"></div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="titulo" class="form-control" placeholder="Titulo de rama">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Descripción</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="descripcion" class="form-control" placeholder="Descripción de rama">
                                    </div>
                                </div>                              
                            </form>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="registrarRama()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save fa-2x"></i> Guardar</button>
                            <button type="button" @click="actualizarRama()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save fa-2x"></i> Actualizar</button>                           
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            cambiarPagina(page, buscar, criterio){
                ...
                me.listarRama(page, buscar, criterio);
            },

        },

        mounted() {
            this.listarRama(1, this.buscar, this.criterio);        
        }
    }
</script>