    ...
    <nav class="sidebar-nav" style="background-color: #9FD5E4;">
        <ul class="nav">
            ...
            <li @click="menu=1" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-list"></i><font color="#372FB4">Empresas</a>
            </li>
            
            <li @click="menu=2" class="nav-item">
                <a class="nav-link" href="#"><i class="fa fa-tasks"></i><font color="#372FB4">Tipo de Empresa</a>
            </li>  
